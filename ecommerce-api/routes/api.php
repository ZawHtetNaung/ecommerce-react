...
Route::get('/public/offers', [ProductController::class, 'publicOffers']);
Route::get('/public/offers/summary', [ProductController::class, 'publicOffersSummary']);
...
Route::get('/public/blog-categories', [BlogCategoryController::class, 'publicIndex']);
Route::get('/public/blog-posts', [BlogPostController::class, 'publicIndex']);
Route::get('/public/blog-posts/{slug}', [BlogPostController::class, 'publicShow']);
